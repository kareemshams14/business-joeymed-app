...
import {
  Scale, Pill, ShieldCheck, FlaskConical, RefreshCw,
  Heart, Sparkles, Wrench, TrendingUp, CirclePlus,
  Check, ArrowRight,
} from "lucide-react";
...
const longevityAddons = ["Red light therapy masks", "Collagen supplements", "Microneedling devices", "Cold therapy / plunges", "Diet and exercise programs", "Personalized supplement stacks"];
    ...
    <ul className="space-y-3">
      {items.map((item, i) => (
        <li key={i} className="flex gap-3 text-[13px] text-text-secondary leading-relaxed">
          <Check size={14} className={`${color} shrink-0 mt-0.5`} strokeWidth={2} />
          {item}
        </li>
      ))}
    </ul>
...
function IconBox({ Icon, className = "" }: { Icon: LucideIcon; className?: string }) {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center max-w-[680px] mx-auto mb-12">
          ...
          <p className="text-[17px] text-text-secondary leading-relaxed">
            ...
            safety screening, and ongoing monitoring.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-2">
                <IconBox Icon={Scale} className="bg-blue/8 text-blue" />
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-bg-alt rounded-2xl p-5">
                  ...
                  <ul className="text-[13px] text-text-secondary space-y-1.5">
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>Compounding consent (testing, consistency, risk disclosures)</li>
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>GLP-1/GIP consent (pancreatitis, gallbladder, gastroparesis)</li>
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>Pregnancy/BMI consents for off-label ranges</li>
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>Selfie verification policy disclosure</li>
                  </ul>
                </div>
                <div className="bg-bg-alt rounded-2xl p-5">
                  <h4 className="text-[13px] font-bold mb-2">Business Advantages</h4>
                  <ul className="text-[13px] text-text-secondary space-y-1.5">
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>Personalization = differentiation & reduced discontinuation</li>
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>Embedded disqualifiers standardize risk at high volume</li>
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>Iterative optimization creates sticky, long-term retention</li>
                    <li className="flex gap-2"><span className="text-text-muted">&bull;</span>Cross-sell: metabolic support, sleep, mental health, fitness</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue/4 to-white rounded-3xl p-8 sm:p-10 border border-blue/10">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={ShieldCheck} className="bg-blue/8 text-blue" />
        ...
        {tab === "bwl" && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-2">
                <IconBox Icon={Pill} className="bg-blue-dark/8 text-blue-dark" />
            ...
            <div className="bg-gradient-to-br from-blue-light to-white rounded-3xl p-8 sm:p-10 border border-blue-dark/10">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={ShieldCheck} className="bg-blue-dark/8 text-blue-dark" />
        ...
        {tab === "trt" && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={Pill} className="bg-orange/8 text-orange" />
              ...
              {trtMedications.map((cat) => (
                <div key={cat.category} className="mb-8 last:mb-0">
                  <h4 className="text-[12px] font-bold text-orange uppercase tracking-wider mb-3">{cat.category}</h4>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
                <div className="flex items-center gap-3 mb-6">
                  <IconBox Icon={FlaskConical} className="bg-orange/8 text-orange" />
              ...
              <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
                <div className="flex items-center gap-3 mb-6">
                  <IconBox Icon={RefreshCw} className="bg-orange/8 text-orange" />
                  <h3 className="text-base font-bold">Follow-Up Labs (Q3 Months)</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {trtFollowUpLabs.map((lab) => <LabChip key={lab} label={lab} />)}
                </div>
                <p className="text-[12px] text-text-muted mt-4">Quarterly monitoring ensures ongoing safety and enables timely dose adjustments.</p>
              </div>
            </div>
            <div className="bg-gradient-to-br from-orange/4 to-white rounded-3xl p-8 sm:p-10 border border-orange/10">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={ShieldCheck} className="bg-orange/8 text-orange" />
        ...
        {tab === "fhrt" && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={Pill} className="bg-purple/8 text-purple" />
                <div>
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={Heart} className="bg-purple/8 text-purple" />
                <div>
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={CirclePlus} className="bg-purple/8 text-purple" />
                <div>
            ...
            <div className="bg-gradient-to-br from-purple/4 to-white rounded-3xl p-8 sm:p-10 border border-purple/10">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={ShieldCheck} className="bg-purple/8 text-purple" />
        ...
        {tab === "ed" && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-2">
                <IconBox Icon={Pill} className="bg-rose/8 text-rose" />
                <h3 className="text-xl font-bold">Erectile Dysfunction Formulary</h3>
              </div>
              <p className="text-[13px] text-text-muted mb-6">Labs: Not required &bull; Follow-up: Every 6 months &bull; 30M+ men affected in the US alone</p>
        ...
        {tab === "pe" && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              ...
              <p className="text-[13px] text-text-muted mb-6">Labs: Not required &bull; Follow-up: 3–6 months &bull; Affects 1 in 3 men</p>
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-4">
                <IconBox Icon={Wrench} className="bg-rose/8 text-rose" />
        ...
        {tab === "wsh" && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-2">
                <IconBox Icon={Heart} className="bg-rose/8 text-rose" />
                <h3 className="text-xl font-bold">Women&apos;s Sexual Health Formulary</h3>
              </div>
              <p className="text-[13px] text-text-muted mb-6">Labs: Not required &bull; Follow-up: Every 6 months &bull; Up to 40% of women report sexual desire concerns</p>
            ...
            <div className="bg-gradient-to-br from-rose/4 to-white rounded-3xl p-8 sm:p-10 border border-rose/10">
              <div className="flex items-center gap-3 mb-4">
                <IconBox Icon={TrendingUp} className="bg-rose/8 text-rose" />
        ...
        {tab === "longevity" && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-2">
                <IconBox Icon={Sparkles} className="bg-amber/8 text-amber" />
                <h3 className="text-xl font-bold">Anti-Aging & Longevity Formulary</h3>
              </div>
              <p className="text-[13px] text-text-muted mb-6">Labs: Not required &bull; Follow-up: Every 6 months &bull; Subscription-based model</p>
              <MedTable meds={longevityMeds} />
            </div>
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-border">
              <div className="flex items-center gap-3 mb-6">
                <IconBox Icon={Wrench} className="bg-amber/8 text-amber" />
            ...
            <div className="bg-gradient-to-br from-amber/4 to-white rounded-3xl p-8 sm:p-10 border border-amber/10">
              <div className="flex items-center gap-3 mb-4">
                <IconBox Icon={TrendingUp} className="bg-amber/8 text-amber" />
                <h3 className="text-xl font-bold">Market Opportunity</h3>
              </div>
              <p className="text-[13px] text-text-secondary leading-relaxed">
